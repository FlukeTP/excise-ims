...
import { Mgc013Service } from "./mgc01-3.service";
...
export class Mgc013Component implements AfterViewInit {
  ...
  constructor(
    ...
    private mgc013Service: Mgc013Service
  ) { }

  ngAfterViewInit() {
    this.authService.reRenderVersionProgram('REP-01013');


    this.mgc013Service.getData().then(res => {
