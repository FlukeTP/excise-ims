...
import { Cop08Serivce } from "projects/check-operation/cop08/cop08.service";

@Component({
  selector: "cop08",
  templateUrl: "./cop08.component.html",
  styleUrls: [],
  providers: [Cop08Serivce]
})
export class Cop08Component implements OnInit {
  month: any;
  formatter1: any;
  formatter2: any;
