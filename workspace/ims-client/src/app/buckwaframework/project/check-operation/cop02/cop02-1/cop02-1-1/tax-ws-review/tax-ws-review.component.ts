...
declare var $: any;
@Component({
  selector: 'app-tax-ws-review',
  templateUrl: './tax-ws-review.component.html',
  styleUrls: ['./tax-ws-review.component.css']
})
export class TaxWsReviewComponent implements OnInit {
