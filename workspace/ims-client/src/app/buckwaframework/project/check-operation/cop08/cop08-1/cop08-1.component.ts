...
import { Cop081Service } from "projects/check-operation/cop08/cop08-1/cop08-1.service";
import { SummaryModel } from "projects/check-operation/cop08/cop08-1/summaryFooter.model";
declare var $: any;
@Component({
  selector: "cop08-1",
  templateUrl: "./cop08-1.component.html",
  styleUrls: ["./cop08-1.component.css"],
  providers: [Cop081Service]
})
export class Cop081Component implements OnInit, AfterViewInit {
  breadcrumb: BreadCrumb[] = [
    { label: "ตรวจปฏิบัติการ", route: "#" },
    { label: "วิเคราะห์แนวโน้มการชำระภาษีของผู้ประกอบการ", route: "#" },
  ...
  constructor(
    ...
    private cop081Service: Cop081Service,
  ...
  ngOnInit() {
    ...
    document.getElementById("trDrinamic").innerHTML =
      ...
      '<th colspan="3" style="text-align: center !important">การตรวจสอบภาษีย้อนหลัง 3 ปี</th> ' +
  ...
  selectExciseProductType(productionType) {
    ...
    this.cop081Service.countList(this.productionType, this.coordinatesFlag, formSearch, dateFrom, dateTo).then(res => {
      this.countPay = res;
